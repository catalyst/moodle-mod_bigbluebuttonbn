...
$string['bigbluebuttonbn:meetinganalytics'] = 'Able to view the analytics for a BBB meeting/session.';
$string['bigbluebuttonbn:recordinganalytics'] = 'Able to view the analytics for BBB recordings.';
...
$string['config_participant_guestlink_requires_access_duration'] = 'Guestslinks must expire';
$string['config_participant_guestlink_requires_access_duration_description'] = 'Ensure guestlinks have an end datetime';
$string['config_participant_guestlink_access_duration_expiry_default'] = 'Default duration until guestlink expires';
$string['config_participant_guestlink_access_duration_expiry_default_description'] = 'Once set, this will default for all new instances';
$string['config_participant_guestlink_access_duration_maximum'] = 'Maximum duration of guestlink access';
$string['config_participant_guestlink_access_duration_maximum_description'] = 'Sets the maximum duration a guestlink is valid for (0 = Not limited)';
...
$string['view_message_nostatistics'] = 'There are no meeting statistics available.';
...
$string['view_recording_analytics'] = 'Analytics';
$string['view_recording_show_analytics'] = 'Show Analytics';
...
$string['view_analytics_heading_overview'] = 'Overview';
$string['view_analytics_heading_attention'] = 'Attention';
$string['view_analytics_heading_files'] = 'Files';
$string['view_analytics_participant'] = 'Participant';
$string['view_analytics_duration'] = 'Duration';
$string['view_analytics_timejoined'] = 'Time Joined';
$string['view_analytics_timeleft'] = 'Time Left';
$string['view_analytics_polling'] = 'Polling';
$string['view_analytics_activityscore'] = 'Activity Score';
$string['view_analytics_talktime'] = 'Talk Time';
$string['view_analytics_messages'] = 'Messages';
$string['view_analytics_emojis'] = 'Emojis';
$string['view_analytics_handraises'] = 'Hand Raises';
$string['view_analytics_poll'] = 'Poll';
$string['view_analytics_poll_responses'] = 'responses';
$string['view_analytics_sessiondate'] = 'Session Date';
$string['view_analytics_moderators'] = 'Moderators';
$string['view_analytics_viewers'] = 'Viewers';
$string['view_analytics_number_of_students_speaking'] = '# of Students Speaking';
...
$string['view_analytics_heading_past_month'] = 'Past Month';
...
$string['view_analytics_status'] = 'Status';
$string['view_analytics_createtime'] = 'Created At';
$string['view_analytics_meetingduration'] = 'Meeting Duration';
$string['view_analytics_playbackduration'] = 'Playback Duration';
$string['view_analytics_processingtime'] = 'Processing At';
